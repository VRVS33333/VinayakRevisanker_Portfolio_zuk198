...
_The point of this project was to understand fork/ pull requisitions between two people_ 

## Description of data and data source
_The data is an excel sheet with peoples Weight, Height, Gender and two others that I created which is Shoe size and Eye Color._
...
#| tbl-cap: "Linear model fit table for Column 3."
#| echo: FALSE
knitr::kable(resulttable1)

#| label: tbl-resulttable2
#| tbl-cap: "Linear model fit table for Column 4."
#| echo: FALSE
knitr::kable(resulttable2)
...
_At the end I add a linear regression models for the last parts of the code for the new colomns of the excel file._

## Strengths and Limitations
_Easy to understand coding and I was able to edit the code based on the excel sheet._

## Conclusions
_Learning to use Fork and Pull Method for Github as well as working with others _
